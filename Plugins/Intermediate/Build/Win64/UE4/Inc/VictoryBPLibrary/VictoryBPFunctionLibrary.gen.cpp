...
static struct FScriptStruct_VictoryBPLibrary_StaticRegisterNativesFVictoryInput
{
	...
	UFunction* Z_Construct_UFunction_UVictoryBPFunctionLibrary_GetUnixTimeStamp()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("GetUnixTimeStamp"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), nullptr, (EFunctionFlags)0x14C22401, 65535, sizeof(VictoryBPFunctionLibrary_eventGetUnixTimeStamp_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(ReturnValue, VictoryBPFunctionLibrary_eventGetUnixTimeStamp_Parms), 0x0010000000000580);
			UProperty* NewProp_UTCTime = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("UTCTime"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(UTCTime, VictoryBPFunctionLibrary_eventGetUnixTimeStamp_Parms), 0x0010000008000182, Z_Construct_UScriptStruct_FDateTime());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Victory BP Library|System"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Public/VictoryBPFunctionLibrary.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Blueprints does not support int64 so at some pt in future int32 will not be enough, probably by then dolphins will rule the world, or UE4 BP will support int64, or both!  <3 Rama"));
	...
	UFunction* Z_Construct_UFunction_UVictoryBPFunctionLibrary_GetUTCFromUnixTimeStamp()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("GetUTCFromUnixTimeStamp"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), nullptr, (EFunctionFlags)0x14C22401, 65535, sizeof(VictoryBPFunctionLibrary_eventGetUTCFromUnixTimeStamp_Parms));
			UProperty* NewProp_UTCTime = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("UTCTime"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(UTCTime, VictoryBPFunctionLibrary_eventGetUTCFromUnixTimeStamp_Parms), 0x0010000000000180, Z_Construct_UScriptStruct_FDateTime());
			UProperty* NewProp_UnixTimeStamp = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("UnixTimeStamp"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(UnixTimeStamp, VictoryBPFunctionLibrary_eventGetUTCFromUnixTimeStamp_Parms), 0x0010000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UClass* Z_Construct_UClass_UVictoryBPFunctionLibrary()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->LinkChild(Z_Construct_UFunction_UVictoryBPFunctionLibrary_GetUnixTimeStamp());
				OuterClass->LinkChild(Z_Construct_UFunction_UVictoryBPFunctionLibrary_GetUserDisplayAdapterBrand());
				OuterClass->LinkChild(Z_Construct_UFunction_UVictoryBPFunctionLibrary_GetUTCFromUnixTimeStamp());
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UVictoryBPFunctionLibrary_GetUnixTimeStamp(), "GetUnixTimeStamp"); // 937701641
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UVictoryBPFunctionLibrary_GetUTCFromUnixTimeStamp(), "GetUTCFromUnixTimeStamp"); // 3215180010
	...
	IMPLEMENT_CLASS(UVictoryBPFunctionLibrary, 2953972494);
